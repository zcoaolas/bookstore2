                ...
                <div class="navbar-collapse collapse ">
                    <ul id="menu-top" class="nav navbar-nav navbar-right">
                        <shiro:hasRole name="admin">
                            <li>
                                <a href="#" class="dropdown-toggle" id="ddlmenuItem" data-toggle="dropdown">Admin Only <i class="fa fa-angle-down"></i></a>
                        ...
                        <li><a href="${ctx}/book/bookList" class="menu-top-active">Books on sale</a></li>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <c:forEach var="i" items="${books}">
                                    <tr>
                                        <td class="center">${i.bookId}</td>
                                        <td class="center">
                                            <img src="${ctx}/assets/img/cover.png">
                                        </td>
                                        <td class="center">
                                            <a href="${ctx }/book/bookDetail?id=${i.bookId}">${i.bookName}</a>
                                        </td>
                                        <td class="center">${i.category}</td>
                                        <td class="center">$ ${i.bookPrice}</td>
                                    </tr>
                                </c:forEach>
